...
export const CustomDialogContent = ({ children, className } : Props) => (
    <Dialog.Content className={twMerge(["on-open-modal fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 m-auto rounded-2xl border flex flex-col lg:flex-row gap-2   z-[100] border-zinc-200 bg-zinc-100 "], [className]) }>
        <Dialog.Close
            asChild
        >
            <TextButton
