...
const noticias: Noticia[] = [
  {
    ...
    nm_img: DefaultImage,
    tags: [
      { nm_slug: "inteligencia-artificial", dt_cadastro: "2024-01-15T08:30:00Z" },
      { nm_slug: "tecnologia", dt_cadastro: "2024-01-10T12:00:00Z" }
    ]
  },
  {
    id_noticia: 2,
    ...
    nm_img: Busao,
    tags: [
      { nm_slug: "saude", dt_cadastro: "2024-02-01T09:45:00Z" },
      { nm_slug: "bem-estar", dt_cadastro: "2024-02-02T10:20:00Z" }
    ]
  },
  {
    id_noticia: 3,
    ...
    nm_img: Violao,
    tags: [
      { nm_slug: "nutricao", dt_cadastro: "2024-02-10T11:00:00Z" },
      { nm_slug: "saude", dt_cadastro: "2024-02-15T15:30:00Z" }
    ]
  },
  {
    id_noticia: 4,
    ...
    nm_img: upa,
    tags: [
      { nm_slug: "economia", dt_cadastro: "2024-02-05T14:00:00Z" },
      { nm_slug: "financas", dt_cadastro: "2024-02-07T16:20:00Z" }
    ]
  },
  {
    id_noticia: 5,
    ...
    nm_img: Busao,
    tags: [
      { nm_slug: "moda", dt_cadastro: "2024-01-20T09:00:00Z" },
      { nm_slug: "sustentabilidade", dt_cadastro: "2024-01-22T10:45:00Z" }
    ]
  },
  {
    id_noticia: 6,
    ...
    nm_img: Violao,
    tags: [
      { nm_slug: "blockchain", dt_cadastro: "2024-02-12T14:30:00Z" },
      { nm_slug: "criptomoedas", dt_cadastro: "2024-02-15T15:00:00Z" }
    ]
  },
  {
    id_noticia: 7,
    ...
    nm_img: upa,
    tags: [
      { nm_slug: "educacao", dt_cadastro: "2024-01-25T10:30:00Z" },
      { nm_slug: "desenvolvimento-pessoal", dt_cadastro: "2024-01-27T12:10:00Z" }
    ]
  },
  {
    id_noticia: 8,
    ...
    nm_img: Busao,
    tags: [
      { nm_slug: "turismo", dt_cadastro: "2024-02-03T08:40:00Z" },
      { nm_slug: "sustentabilidade", dt_cadastro: "2024-02-05T09:50:00Z" }
    ]
  },
  {
    id_noticia: 9,
    ...
    nm_img: DefaultImage,
    tags: [
      { nm_slug: "tecnologia", dt_cadastro: "2024-01-30T14:20:00Z" },
      { nm_slug: "programacao", dt_cadastro: "2024-02-01T16:10:00Z" }
    ]
  },
  {
    id_noticia: 10,
    ...
    nm_img: upa,
    tags: [
      { nm_slug: "meio-ambiente", dt_cadastro: "2024-02-07T10:15:00Z" },
      { nm_slug: "sustentabilidade", dt_cadastro: "2024-02-09T11:30:00Z" }
    ]
  }
];
